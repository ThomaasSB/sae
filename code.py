...
# Rendu => Rapport de deux pages et un code python à upload sur github (la mettre en colaborateur)
...
query = '''
    SELECT o.officeCode as CodeBureau, o.city as Ville, o.country as Pays,
           COUNT(DISTINCT c.customerNumber) AS NombreClient,
           COUNT(DISTINCT ord.orderNumber) AS NombredeProduit,
           SUM(p.amount) AS Total,
           COUNT(DISTINCT CASE WHEN c.country != o.country THEN c.customerNumber END) AS Nombre
    FROM Offices o
...
query = '''
    SELECT p.productCode, p.productName,
           ...
           COUNT(DISTINCT o.customerNumber) AS Nombre_Client
    FROM Products p
